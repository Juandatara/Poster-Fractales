\section{Dimensión de Hausdorff y Autosimilitud}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Figuras/copo_nieve_koch.png}
    \caption{Ejemplo del fractal del copo de nieve de Koch, cuya dimensión fractal exacta es $d \approx 1.2619$.}
    \label{fig:copo_koch}
\end{figure}
